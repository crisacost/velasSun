...
import imgjasmin from '../assets/img/jasmin.jpg';
...
function ItemListContainer() {
  ...
  useEffect(() => {
    const mockItems = [
      { id: 1, name: 'Vela Aromática Jasmin', category: 'aromaticas', Image: imgjasmin },
      { id: 2, name: 'Vela Aromática Lavanda', category: 'aromaticas', imgLavanda },
